                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <div id="policy">
                            <div class="d-flex">
                                ...
                                <div class="return text-center mr-5">
                                    ...
                                    <a href="#" class="font-rale font-size-12">Calex <br>Deliverd</a>
                                </div>
                                <div class="return text-center mr-5">
                                    <div class="font-size-20 my-2 color-second">
                                        <span class="fas fa-check-double border p-3 rounded-pill"></span>
                                    </div>
                                    <a href="#" class="font-rale font-size-12">1 Week <br>Warranty</a>
                                </div>
                            </div>
                        </div>
                        <!--    !policy -->
                        ...
                        <div id="order-details" class="font-rale d-flex flex-column text-dark">
                            ...
                            <small>Sold by <a href="#">Calex </a>(4.5 out of 5 | 18,198 ratings)</small>
